...
# NAME: Noah Ellis
# DATE: 10/2/2025
# BRIEF DESCRIPTION: Filtering emails based on words in the subject line 
...
#if 'trigger_word' in subject: print(expected output) remember subject.lower():
print('')
